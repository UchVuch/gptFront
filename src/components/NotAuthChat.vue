  ...
  <section class="d-flex flex-column">
    ...
    <div class="tryChat">
      ...
      <div class="action mt-5">
        <v-select density="compact" max-height="40px" style="width:280px; font-size: 16px;" label="Выбирите роль"></v-select>
    ...
    <div class="footerBloc d-flex flex-row">
      <div class="inviteBloc d-flex flex-column px-5">
        ...
        <div class="authAction d-flex flex-row mt-3">
          <v-btn  @click="redirectToRegistr" color="rgba(69, 39, 160, 1)" height="52px" width=40% style="color: white">
              Зарегистрироваться
          </v-btn>
          <p class="white mx-5">или</p>
          <v-btn  @click="redirectToAuth" color="rgba(69, 39, 160, 1)" height="52px" width=40% style="color: white">
            Войти
          </v-btn>
        </div>
      </div>
...
import MessageCard from '../components/MessageCard.vue'
  ...
  methods: {
    redirectToRegistr() {
      this.$router.push('/register') // здесь указывается путь к странице, на которую нужно перейти
    },
    redirectToAuth() {
      this.$router.push('/auth') // здесь указывается путь к странице, на которую нужно перейти
    },
